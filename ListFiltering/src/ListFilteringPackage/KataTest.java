...
class ExampleTests {
  ...
  public void examples() {
    assertEquals(List.of(1, 0, 15), Kata.filterList(List.of(1, "a", "b", 0, 15)), "For input: [1, 2, \"a\", \"b\"]");
  ...
  @Test
  public void returnNullGivenCharArray() {
	  assertEquals(List.of(), Kata.filterList(List.of("a", "b")), "For input: [\"a\", \"b\"]");
  }
}